...
public class ShiroConfigurer2 {
    ...
    public ShiroFilterChainDefinition shiroFilterChainDefinition() {
        ...
        /*chain.addPathDefinition( "/userInfo/selectById", "authc, perms[select]");
